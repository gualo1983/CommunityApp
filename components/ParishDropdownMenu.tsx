    ...
    <View style={dropdownStyles.listItem}>
      ...
      <TouchableOpacity
        ...
        <MaterialCommunityIcons
          ...
          size={24}
          color={item.isFavorite ? theme.colors.tabBarActive : theme.colors.textSecondary}
        />
      </TouchableOpacity>
    </View>
  );
  ...
  return (
    <View>
      <TouchableOpacity
        ...
        <MaterialCommunityIcons name="menu-down" size={24} color={theme.colors.headerText} />
      </TouchableOpacity>
        ...
        <View style={dropdownStyles.modalContainer}>
          <View style={dropdownStyles.modalContent}>
            <View style={dropdownStyles.modalHeader}>
              <Text style={dropdownStyles.modalTitle}>Seleziona Parrocchia</Text>
              <TouchableOpacity
                onPress={() => {
                  setModalVisible(false);
                  setSearchText('');
            ...
            <FlatList
              data={[
                ...(favoriteParishes.length > 0
                  ? [{ id: 'favorites-header', name: 'Preferite', type: 'header' }]
                  : []),
                ...favoriteParishes,
                ...(otherParishes.length > 0
                  ? [{ id: 'others-header', name: 'Altre Parrocchie', type: 'header' }]
                  : []),
                ...otherParishes,
              ]}
