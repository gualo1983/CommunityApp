...
const ConfirmDeleteModal = ({ visible, onClose, onConfirm, tabName }: ConfirmDeleteModalProps) => {
  ...
  const modalStyles = StyleSheet.create({
    ...
    confirmButton: {
      backgroundColor: '#FF6347', // Rosso per la conferma di eliminazione
    },
    modalTitle: {
    ...
    <Modal animationType="fade" transparent={true} visible={visible} onRequestClose={onClose}>
      <View style={modalStyles.centeredView}>
        <View style={modalStyles.modalView}>
          <Text style={modalStyles.modalTitle}>Sei sicuro di voler eliminare la tab &quot;{tabName}&quot;?</Text>
