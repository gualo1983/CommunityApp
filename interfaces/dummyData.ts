...
export const DUMMY_EVENTS: Event[] = [
  {
    ...
    description:
      "Partecipa alla messa domenicale nella nostra parrocchia. Un momento di preghiera e comunità.",
    imageUrl:
  ...
  },
  {
    ...
    category: "Diocesano",
    description:
      "Unisciti a noi per il pellegrinaggio annuale al Santuario di Loreto. Partenza alle ore 8:00.",
  },
  {
    id: "3",
    title: "Conferenza Nazionale Giovani",
  ...
  {
    id: "6",
    title: "Corso Prematrimoniale",
    date: "Settembre 2025",
    location: "Diocesi di Milano",
    category: "Diocesano",
  },
];
